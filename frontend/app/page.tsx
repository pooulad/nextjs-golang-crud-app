...
async function getGitHubStars(): Promise<string | null> {
  try {
    const response = await fetch(
      "https://api.github.com/repos/pooulad/nextjs-golang-crud-app",
      {
        headers: {
        ...
        <div className="flex-1 mx-auto">
          <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
            <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
              ...
              <div className="space-x-4">
                ...
                <Link
                  href={"https://github.com/pooulad/nextjs-golang-crud-app"}
                  target="_blank"
                  rel="noreferrer"
                >
                  GitHub
          ...
          >
            <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
              ...
              <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                The purpose of creating this project is to learn for junior
                programmers how to implement a full stack application and create
                the best structure for the application.
              </p>
            </div>
              ...
              <div className="relative overflow-hidden rounded-lg border bg-background p-2">
                <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Using postgresql with golang and connect it to fiber
                      webserver
                    </p>
                  </div>
                </div>
            ...
            <div className="mx-auto text-center md:max-w-[58rem]">
              <p className="leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                Complete crud app written with golang and nextjs
              </p>
            </div>
          </section>
          <section
          ...
          >
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
              ...
              <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                nextjs-golang-crud-app is open source and powered by open source
